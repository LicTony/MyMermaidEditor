    ...
    <div id='diagram' class='mermaid'></div>
        ...
        private async Task RenderDiagram()
        {
            ...
            try
            {
                ...
                // Codificar el código como una cadena más segura para JavaScript
                // Usando JSON.stringify para manejar caracteres especiales
                var jsonString = System.Text.Json.JsonSerializer.Serialize(mermaidCode);
                // Remover las comillas al inicio y final ya que se agregarán en el script
                var jsonCode = jsonString.Substring(1, jsonString.Length - 2);
                
                await webView.CoreWebView2.ExecuteScriptAsync($"renderDiagram({jsonString})");
